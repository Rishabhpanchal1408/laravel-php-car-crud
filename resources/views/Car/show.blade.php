        ...
        <div class="card-body">
            <div class="row">
                <div class="col-12 col-sm-6">
                    ...
                    <div class="col-12">
                        <img src={{ asset('storage/' . $car->car_img) }} class="product-image" alt="Product Image">
                    </div>
                </div>
                <div class="col-12 col-sm-6">
                    <h3 class="my-3">{{ $car->brand->brand_name }}</h3>
                    <h3 class="my-3">{{ $car->color->color_name }}</h3>
                    <h3 class="my-3">{{ $car->type->type_name }}</h3>
                    <h3 class="my-3">{{ $car->engine->engine_name }}</h3>
                    <hr>
                    <div class="bg-gray py-2 px-3 mt-4">
                        <h2 class="mb-0">$<?php echo $car['car_price']; ?></h2>
                    </div>
